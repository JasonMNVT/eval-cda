 ...
 */
final class Version20221214103240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE computer ADD author_id INT DEFAULT NULL, ADD serie_number VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE computer DROP author_id, DROP serie_number');
    }
}
